...
- **Free evaluation sample** on GitHub (`15m`) · **11 timeframes** on [getdata.finance](https://getdata.finance/datasets/meta) · **42,494** `15m` rows in the full archive
- Built for **backtesting**, **algorithmic trading** and **quantitative finance** workflows
- **Weekly refresh** — [getdata.finance](https://getdata.finance) every **Saturday, 8am UTC+0**; GitHub `15m` sample updated in sync

> **Sample on GitHub** · `META_15m.csv` (3,696 rows, `2026-02-06` -> `2026-09-01`, 370.38 KB). **Full archive on [getdata.finance](https://getdata.finance/datasets/meta)** — **42,494** `15m` rows (full `1m`: 637,227), **11 timeframes**, `2020-02-25` -> `2026-09-01`.
...
df = pd.read_csv('META_15m.csv', parse_dates=['time'])
...
The complete **META** archive on **[getdata.finance](https://getdata.finance/datasets/meta)** includes **11 OHLCV timeframes** (1m · 3m · 5m · 15m · 30m · 1H · 4H · 12H · 1D · 3D · 1W) — **42,494** rows at `15m`, plus all other timeframes in the same ZIP.
